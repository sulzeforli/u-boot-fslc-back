...
#define DISP0_PWR_EN	IMX_GPIO_NR(6, 16)

#define DISP1_PWR_EN	IMX_GPIO_NR(6, 15)
...
static iomux_v3_cfg_t const ecspi1_pads[] = {
	...
	IOMUX_PADS(PAD_EIM_D19__ECSPI1_SS1 | MUX_PAD_CTRL(NO_PAD_CTRL)),
};
...
#define USDHC3_CD_GPIO	IMX_GPIO_NR(2, 2)
...
{
	disable_lvds(dev);
	gpio_direction_output(LVDS_PWR_EN, 0);
	imx_enable_hdmi_phy();
}
